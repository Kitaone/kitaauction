        ...
        <div class="collapse show " id="dashboardsExamples">
          <ul class="nav ">
           ...
           <li class="nav-item active">
            <a class="nav-link text-white active" href="automotive.html">
              <span class="sidenav-mini-icon">
               A 
             </span>
             <span class="sidenav-normal ms-2 ps-1">
...
<li class="nav-item">
  <a data-bs-toggle="collapse" href="#pagesExamples" class="nav-link text-white " aria-controls="pagesExamples" role="button" aria-expanded="false">
    <i class="material-icons-round {% if page.brand == 'RTL' %}ms-2{% else %} me-2{% endif %}">
      image
    </i>
    <span class="nav-link-text ms-2 ps-1">
      Pages
  ...
  <div class="collapse " id="pagesExamples">
    <ul class="nav ">
      <li class="nav-item ">
       ...
       <li class="nav-item">
        <a class="nav-link text-white " href="../pages/profile/messages.html">
          <span class="sidenav-mini-icon">
           M 
         </span>
         <span class="sidenav-normal ms-2 ps-1">
